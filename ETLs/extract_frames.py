...
def main():
    input_video_path = 'sample_data/raw/VID_1.mp4'
    output_frame_folder = 'sample_data/frames'
    source_name = f'market_{input_video_path[-9:-4]}'
    
    get_random_frames(
        input_path=input_video_path,
        output_path=output_frame_folder,
